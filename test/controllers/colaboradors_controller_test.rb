...
class ColaboradorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create colaborador" do
    assert_difference('Colaborador.count') do
      post colaboradors_url, params: { colaborador: { cpfColaborador: @colaborador.cpfColaborador, ctpsColaborador: @colaborador.ctpsColaborador, nomeColaborador: @colaborador.nomeColaborador, tipoColaborador: @colaborador.tipoColaborador } }
    end
  ...
  test "should update colaborador" do
    patch colaborador_url(@colaborador), params: { colaborador: { cpfColaborador: @colaborador.cpfColaborador, ctpsColaborador: @colaborador.ctpsColaborador, nomeColaborador: @colaborador.nomeColaborador, tipoColaborador: @colaborador.tipoColaborador } }
