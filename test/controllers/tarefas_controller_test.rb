...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference('Tarefa.count') do
      post tarefas_url, params: { tarefa: { descTarefa: @tarefa.descTarefa, diaVencimento: @tarefa.diaVencimento } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { descTarefa: @tarefa.descTarefa, diaVencimento: @tarefa.diaVencimento } }
