...
class SetorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create setor" do
    assert_difference('Setor.count') do
      post setors_url, params: { setor: { nomeSetor: @setor.nomeSetor, siglaSetor: @setor.siglaSetor } }
    end
  ...
  test "should update setor" do
    patch setor_url(@setor), params: { setor: { nomeSetor: @setor.nomeSetor, siglaSetor: @setor.siglaSetor } }
