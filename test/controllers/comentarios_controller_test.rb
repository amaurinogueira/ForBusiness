...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post comentarios_url, params: { comentario: { dataComentario: @comentario.dataComentario, descComentario: @comentario.descComentario } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { dataComentario: @comentario.dataComentario, descComentario: @comentario.descComentario } }
