...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { cnpjEmpresa: @empresa.cnpjEmpresa, nomeEmpresa: @empresa.nomeEmpresa, statusEmpresa: @empresa.statusEmpresa, tipoEmpresa: @empresa.tipoEmpresa } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { cnpjEmpresa: @empresa.cnpjEmpresa, nomeEmpresa: @empresa.nomeEmpresa, statusEmpresa: @empresa.statusEmpresa, tipoEmpresa: @empresa.tipoEmpresa } }
